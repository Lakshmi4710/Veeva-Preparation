...
INSERT INTO orderss (id, order_date, order_amount)
VALUES
    (1, '2023-05-09', 1250),
    (2, '2023-05-09', 900),
    (3, '2023-05-10', 1810),
...
GROUP BY order_date;
-- Alternate 'IN' usage in above query.
SELECT
    order_date,
    COUNT(order_id) AS total_orders
FROM orders
...
-- Query 7: List All Orders Placed on Specific Dates with Customer Names ,Dates: 2023-07-04 and 2023-07-06
SELECT
    o.order_id,
    o.order_date,
    c.cust_name,
